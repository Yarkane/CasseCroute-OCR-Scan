...
func parseArgs() (config, error) {
	...
	pflag.StringVar(&cfg.WebServerPort, "port", cfg.WebServerPort, "Port for the web server.")
	...
	if len(cfg.WebServerPort) == 0 {
		return cfg, errors.New("web server port can not be empty")
	}
